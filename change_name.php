    ...
    <div class="content">
      ...
      <div class="container-fluid">
          ...
          <div class="tab-pane active" id="settings">
            <form class="form-horizontal" method="POST" action="handlers/change_name_handler.php">
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Current name:</label>  <?php echo  $row["first_name"]." ".$row["last_name"]?>
                <div class="col-sm-10">
                </div>
              </div>
