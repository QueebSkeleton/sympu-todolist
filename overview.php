          ...
          <div class="col-md-3">
            <div class="sticky-top mb-3">
              ...
              <!-- LEGEND OF THE TASKS --> 
               <div class="card">
                  <div class="card-body">
                      <span style="color:#E77471;font-size: 15.5px;"><i class="fas fa-square"></i>  Online Meeting </span>
                      <span style="color:#00a65a;font-size: 15.5px;"><i class="fas fa-square"></i>  Assignment</span>
                      <span style="color:#f39c12;font-size: 15.5px;"><i class="fas fa-square"></i>  Quiz</span>
                </div>
              </div>
